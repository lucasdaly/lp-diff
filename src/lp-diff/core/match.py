...
def compare(old_lines,new_lines,candidate_sets,threshold=0.5, split_threshold=0.5):
    final_matches = []
    split_matches = []
    merge_matches = []
    unmatched_old = []
    ...
    # Add old lines that were matched to used_old_lines
    used_old_lines.update(matched_old_lines)
